...
if($_REQUEST['a']=="1")
{
	echo "<script>alert('Event Added Successfully'); window.location = 'select.php';</script>";
}
...
elseif($i==6)
{
  ...
  elseif($i==5 )
  {
	  ...
	  ".str_replace('_', ' ', $name)."</label><input type='text' name='$name' value='New' readonly class='form-control'></div>
                                        </div>";
  }
