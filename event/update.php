...
elseif($i==5 )
  ...
  elseif($i==6 )
  {
	  ...
	  ".str_replace('_', ' ', $name)."</label><input type='text' name='$name' value='$datas' readonly class='form-control' > </div>
                                        </div>";
  }
 ...
 elseif($i==30 )
   ...
   elseif($type_only=="date" )
  {
	  ...
	  <input type='date' name='$name'  class='form-control' value='$datas'></div></div>";
