...
if(isset($_POST['submit']))
{
 ...
 $query = "SELECT * FROM tbl_fingerprint WHERE user='$user' and user_type='student'";
...
$sql = "insert into tbl_fingerprint(user,fingerprint,user_type,batch) values('$exampleInputEmail1','$txtIsoTemplate','student','$batch');";
...
{
	mysqli_query($conn, "UPDATE tbl_fingerprint SET fingerprint='$txtIsoTemplate' WHERE user='$exampleInputEmail1' AND user_type='student' AND batch='$batch'");
