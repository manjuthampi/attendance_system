...
if($_REQUEST['a']=="1")
{
	echo "<script>alert('Sucessfully Asked'); window.location = 'select.php';</script>";
}
...
elseif($i==5)
{
	echo "<input type='hidden' name='$name' value='unanswered' class='form-control' >";
}
...
echo "<select name='$name' class='form-control'>";
    ...
    while($row2 =mysqli_fetch_array($result2))
    {
		...
		echo "<option value='$row2[id]'>$row2[student]</option>";
	}
	  echo "</select>";
