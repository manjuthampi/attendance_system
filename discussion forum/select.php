...
<?php
	...
	echo "<div class='col-sm-2' style='float:right;margin-bottom:10px;'><form action='form.php' method='post'><input type='submit' name='view' value='Ask Question' class='form-control btn-danger'></form></div>";
 ...
 <?php  
  // $i=0;
   echo "<tbody>";
 	...
 	$result = mysqli_query($con,"SELECT * FROM $table where student_name='$_SESSION[userid]'");
...
$row2 =mysqli_fetch_array($result2);
			...
			*/
			...
			if($k==1)
			{
			  $sql2 = "select *  from tbl_teacher where id='$row[teacher_name]' ";
    $result2 = mysqli_query($con, $sql2) or die("Error in Selecting " . mysqli_error($connection));
$row2 =mysqli_fetch_array($result2);
