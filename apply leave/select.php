...
<?php
	...
	echo "<div class='col-sm-2' style='float:right;margin-bottom:10px;'><form action='form.php' method='post'><input type='submit' name='view' value='Apply New' class='form-control btn-danger'></form></div>";
