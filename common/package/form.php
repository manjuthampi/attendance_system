...
echo "<h2>$title</h2>";
echo "<form action='staffadd.php' method='post' enctype='multipart/form-data' name='register_form' id='register_form'>";
...
echo "<select name='$name' class='form-control'>";
    ...
    while($row2 =mysqli_fetch_array($result2))
    {
		...
		echo "<option value='$row2[course]'>$row2[course]</option>";
	}
	  echo "</select>";
